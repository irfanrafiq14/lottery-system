...
<body class="flex min-h-screen items-center justify-center bg-[#0a0a0f] px-4 py-8 text-white">
    <div class="absolute inset-0 bg-gradient-to-br from-luxury-purple/10 via-transparent to-gold/5"></div>
    <div class="relative z-10 w-full max-w-md">
        ...
        <p class="mt-4 text-center">
            <a href="{{ route('home') }}" class="text-sm text-gold/70 hover:text-gold">&larr; Back to home</a>
        </p>
    </div>
    @stack('scripts')
</body>
